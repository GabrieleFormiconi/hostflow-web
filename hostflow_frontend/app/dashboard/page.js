  ...
  return <>
    ...
    <style jsx global>{`
      ...
      @media (max-width: 768px) {
        ...
        .hf-wa-shell.hf-wa-mobile-list .hf-wa-left {
        ...
        .hf-wa-shell.hf-wa-mobile-list .hf-wa-chatbox {
          display: none !important;
        }

        .hf-wa-shell.hf-wa-mobile-chat .hf-wa-left {
          display: none !important;
        }

        .hf-wa-shell.hf-wa-mobile-chat .hf-wa-chatbox {
          display: flex !important;
          width: 100% !important;
        ...
        .hf-wa-client + .hf-wa-client {
          margin-top: 4px !important;
        }

        .hf-wa-client .hf-wa-avatar {
          width: 56px !important;
          height: 56px !important;
          font-size: 20px !important;
        }

        .hf-wa-client-top strong {
          font-size: 20px !important;
        }

        .hf-wa-client-top small {
